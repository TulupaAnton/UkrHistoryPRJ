// src/components/BubbleMenu/BuubleMenuForUdil.jsx
import {
  FaCrown,
  FaLandmark,
  FaFortAwesome,
...
export function BubbleMenuforUdil () {
  ...
  const sections = [
    {
      id: 'vkl',
      title: 'Велике Князівство Литовське',
      icon: <Crown size={16} />
    },
    { id: 'krevska-un', title: 'Кревська Унія', icon: <Scroll size={16} /> },
    {
      id: 'vitovt',
      title: 'Правління Вітовта',
      icon: <FaUserShield size={16} />
    },
    {
      id: 'poland',
      title: 'Українські землі у Польщі',
      icon: <FaLandmark size={16} />
    },
    {
      id: 'krim',
      title: 'Кримське Ханство',
      icon: <FaFortAwesome size={16} />
    },
    { id: 'kozak', title: 'Козацтво', icon: <Shield size={16} /> },
    {
      id: 'culture',
      title: 'Культура та Архітектура',
      icon: <FaChurch size={16} />
    },
    {
      id: 'test',
      title: 'Тести',
